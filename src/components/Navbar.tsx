...
// que quatre, si bien que la Méthode et le Contact n'étaient atteignables
// qu'en faisant défiler à l'aveugle.
// « Suivi » a disparu d'ici en même temps que sa section, fusionnée dans
// BugTrack. BugTrack a lui-même quitté ce bandeau le 2026-07-27 : sa
// section est devenue une page dédiée (/bugtrack), reliée uniquement
// depuis la tuile « BugTrack » de Réalisations, plus depuis un ancre ici.
const NAV_LINKS = [
...
export default function Navbar({
  ...
  return (
    ...
    >
      ...
      <nav className="mx-auto flex h-[76px] w-full max-w-[83rem] items-center justify-between px-6">
        ...
        {/* Gouttière resserrée à 16 px (elle était à 24, puis 32 dès `lg`) :
            ...
            la largeur utile est plafonnée par la grille commune de 83rem, elle ne grandit
      ...
      {open && (
        <div className="border-t border-[var(--header-border)] bg-background md:hidden">
          <div className="mx-auto w-full max-w-[83rem] px-6 pb-4 pt-1">
            {NAV_LINKS.map((link) => (
              <div key={link.href}>
                <Link
                  href={link.href}
